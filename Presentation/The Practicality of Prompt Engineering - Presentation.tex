        ...
        \begin{minipage}{1.1\textwidth}
            \begin{figure}[h]
                \begin{subfigure}[h]{0.4925\textwidth}
                    ...
                    \makebox[\columnwidth][r]{\includegraphics[width=1.1\hsize]{../Output/gsm8k_change_in_accuracy_quality_per_change_in_conversation_length_sorted_by_technique_age.png}}
                ...
                \begin{subfigure}[h]{0.4925\textwidth}
                    ...
                    \makebox[\columnwidth][r]{\includegraphics[width=1.1\hsize]{../Output/cw_change_in_accuracy_quality_per_change_in_conversation_length_sorted_by_technique_age_transformed.png}}
