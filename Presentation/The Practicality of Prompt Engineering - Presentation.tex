...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item Gains on CW are growing but gains on GSM8K are shrinking in transition from TD3 to GPT-4. Methods below sorted by technique age % Better with examples in CW, but better to leave to its own on GSM8K
            \item Low variance is achievable for CW manual few shot, manual CoT with GPT-4
